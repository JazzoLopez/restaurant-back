...
class Mailer
{
    ...
    private function configure()
    {
        ...
        $this->mail->Username = 'jazzielrodriguezlopez@gmail.com'; // Tu correo de Gmail
        $this->mail->Password = 'sdfzmrunowekcxlb'; // Tu contraseña de Gmail o contraseña de aplicación
    ...
    public function sendMail($to, $subject, $userData, $token = null, $altBody = '')
    {
        try {
            ...
            // Construyendo el cuerpo del correo con estilo
            $body = "
            <html>
    <head>
        <style>
